...
class BusinessAddingPage extends StatefulWidget {
  final Map<String, dynamic>? shopToEdit;
  const BusinessAddingPage({super.key, this.shopToEdit});

  @override
  State<BusinessAddingPage> createState() => _BusinessAddingPageState();
}

class _BusinessAddingPageState extends State<BusinessAddingPage> {
  ...
  void initState() {
    ...
    if (widget.shopToEdit != null) {
      ...
      // Tags
      if (shop['tags'] != null) {
        final List<dynamic> tags = shop['tags'];
        for (var t in tags) {
      ...
      if (shop['working_days'] != null) {
        final List<dynamic> wd = shop['working_days'];
        if (wd.isNotEmpty) {
          _selectedDays.clear();
          for (var d in wd) {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final Map<String, dynamic> shopData = {
          ...
          'owner_id': userId,
          if (widget.shopToEdit == null) 'is_verified': false,
        };
        ...
        if (context.mounted) {
          // Immediately refresh the search cache to surface keywords
          await ShopData.fetchShops();
  ...
  Future<void> _getCurrentLocation() async {
    ...
    try {
      ...
      // Update map link forcefully with exact coordinates
      ...
      if (place != null) {
         // Temporarily remove listener if needed, or just set it
                        ...
                        child: DropdownButton<String>(
                          ...
                          onChanged: (String? newValue) {
                            setState(() {
                              ...
                              _customTags.clear(); // Clear custom tags too
                            });
                          },
                    ...
                    if (_selectedCategory.toLowerCase() == 'hospital') ...[
                      ...
                      Container(
                        ...
                        child: Wrap(
                          spacing: 8.0,
                          runSpacing: 4.0,
                          children: _hospitalDepartmentsList.map((String dept) {
                            final isSelected = _selectedHospitalDeptExperts
                                .containsKey(dept);
                            return FilterChip(
                              label: Text(
                                dept,
                              ...
                              onSelected: (bool selected) {
                                setState(() {
                                  if (selected) {
                                    ...
                                    _selectedHospitalDeptExperts.remove(dept);
                                  }
                                });
                              },
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: (_categoryTags[_selectedCategory] ?? []).map((
                              ...
                              final hasChildren = _subCategoryMap.containsKey(
                                tag,
                              );
                              final isExpanded = _selectedSubCategories
                                  .contains(tag);
                                  ...
                                  setState(() {
                                    if (selected) {
                                      ...
                                      if (hasChildren) {
                                        ...
                                        final children =
                                            _subCategoryMap[tag] ?? [];
                                        _selectedTags.removeAll(children);
                                      }
                                    }
                                  });
                                },
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    ...
                                    children: _selectedSubCategories.expand((
                                      ...
                                      return children.map((String childTag) {
                                        final isChildSelected = _selectedTags
                                            .contains(childTag);
                                        return FilterChip(
                                          label: Text(
                                            childTag,
                                  ...
                                  if (_customTags.isNotEmpty) ...[
                                    ...
                                    Wrap(
                                      spacing: 8.0,
                                      runSpacing: 4.0,
                                      children: _customTags.map((String tag) {
                        ...
                        child: _selectedImage == null
                            ? Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 8),
                                  Text(
                                    'Tap to ${widget.shopToEdit != null ? 'update' : 'add'} shop image',
                                    style: TextStyle(
                                      color: Colors.grey,
                                      fontSize: 14,
                                    ),
